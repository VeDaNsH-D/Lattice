...
export const sendInviteEmail = async (emailData) => {
    try {
        ...
        const inviteLink = `http://localhost:3000/invites/${inviteId}/accept`;
        const appName = "ShelfLife";
    ...
    <div style="background-color: #f5f5f5; padding: 40px 20px;">
        ...
        <div style="text-align: center; margin-top: 20px;">
            <p style="margin: 0; color: #9ca3af; font-size: 12px;">
                Have questions? <a href="mailto:support@shelflife.dev" style="color: #2563eb; text-decoration: none;">Contact support</a>
            </p>
        </div>
    </div>
</body>
        ...
        const mailOptions = {
            from: process.env.EMAIL_USER || "noreply@shelflife.dev",
            to: email,
